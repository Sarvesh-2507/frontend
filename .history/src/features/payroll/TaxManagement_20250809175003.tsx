                  ...
                  {rules.map((r, idx) => (
                    <tr key={r.id} className="border-b border-gray-100 dark:border-gray-800">
                      <td className="py-3 px-4">
                        <input aria-label={`Rule name ${idx + 1}`} title="Rule name" value={r.name} onChange={(e) => {
                      ...
                      <td className="py-3 px-4">
                        <input aria-label={`Rule rate ${idx + 1}`} title="Rate percentage" type="number" min={0} max={100} value={r.rate}
                      ...
                      <td className="py-3 px-4">
                        <input aria-label={`Rule threshold ${idx + 1}`} title="Threshold amount" type="number" value={r.threshold ?? ''}
