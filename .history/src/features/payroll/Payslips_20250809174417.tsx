                  ...
                  <tbody>
                    {filtered.map((r) => (
                      <tr key={r.id} className="border-b border-gray-100 dark:border-gray-800">
                        ...
                        <td className="py-3 px-4">
                          <button title="Download payslip" aria-label="Download payslip" className="inline-flex items-center space-x-2 px-3 py-1.5 bg-indigo-600 text-white rounded hover:bg-indigo-700">
