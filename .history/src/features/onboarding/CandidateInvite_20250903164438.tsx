...
const CandidateInvite: React.FC = () => {
  ...
  const fetchOrganizations = async () => {
    try {
      ...
      } else if (organizationsData && typeof organizationsData === 'object' && Array.isArray(organizationsData.results)) {
        // Handle paginated response structure
        setOrganizations(organizationsData.results);
        console.log("✅ Set organizations from results:", organizationsData.results);
      } else {
